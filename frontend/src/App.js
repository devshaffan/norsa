...
function App() {
  ...
  var data = {
    ...
    issuanceHistory: {
      ...
      clientHeader: ['Client', 'Date Time', 'Amount','Payment Period','Nfc Card','Merchant ID','Actions'],
      clientColumns: ['Client_id','DateTime','Amount','PaybackPeriod','NfcCard_id','Merchants_id'],
